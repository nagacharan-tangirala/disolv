...
pub(crate) struct BaseConfig {
    ...
    pub(crate) vehicles: Vec<VehicleSettings>,
    pub(crate) roadside_units: Vec<RSUSettings>,
    pub(crate) base_stations: Vec<BaseStationSettings>,
    pub(crate) controllers: Vec<ControllerSettings>,

...
use crate::sim::vanet::{Link, MultiLinkMap, SingleLinkMap};
...
pub(crate) fn read_all_positions(trace_file: PathBuf, device_id_column: &str) -> TraceMap {
...
pub(crate) fn read_bs2c_links(b2c_links_file: PathBuf) -> SingleLinkMap {
...
pub(crate) fn read_c2c_links(c2c_links_file: PathBuf) -> SingleLinkMap {
